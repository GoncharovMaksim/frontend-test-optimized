...
import { projectDetailsMap } from "./projectData";
...
const projects = [
  {
    ...
    description: "Продающий лендинг для B2B SaaS с интеграцией CRM и аналитикой поведения пользователей.",
  ...
  },
  {
    ...
    category: "AI-агент",
    description: "Умный чат-бот для автоматизации 80% обращений в поддержку интернет-магазина.",
  ...
  },
  {
    ...
    description: "Кастомная CRM для управления продажами недвижимости с аналитикой и интеграцией с банками.",
  ...
  },
  {
    ...
    category: "E-commerce",
    description: "Интернет-магазин с AR-примеркой, AI-рекомендациями и программой лояльности.",
    tags: ["Shopify", "AI", "AR"],
  },
  {
    id: "uiux-0",
    ...
    description: "Полный редизайн мобильного приложения с фокусом на упрощение UX и доступность.",
  ...
  },
  {
    ...
    description: "Многостраничный сайт с каталогом продукции, формой запроса КП и личным кабинетом для дилеров.",
...
export function Work({ onProjectClick }: WorkProps) {
  ...
  return (
    <section id="work" className="py-16 sm:py-24 lg:py-32 px-6 lg:px-8 bg-secondary/20">
              ...
              <div className="flex items-start justify-between mb-4">
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    <h3 style={{ fontSize: '1.5rem' }} className="text-foreground">
                      {project.title}
                    </h3>
                  ...
                  <p className="text-indigo-600 dark:text-accent font-medium mb-3">{project.category}</p>
                </div>
              </div>
