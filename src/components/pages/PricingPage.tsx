...
import { Globe, Palette, Bot, Workflow, Check, Sparkles, ArrowRight } from "lucide-react";
      ...
      <div className="px-6 lg:px-8 pb-20">
        <div className="max-w-7xl mx-auto">
                  ...
                  <div className="p-8 flex flex-col flex-grow">
                    ...
                    <div className="mb-8 pb-8 border-b border-border">
                      <div className="flex items-baseline gap-2">
                        ...
                        <span className="text-muted-foreground" style={{ fontSize: "1.25rem" }}>
                          ₽
                        </span>
                      </div>
                    </div>
          ...
          <motion.div
            ...
            className="mb-20"
          >
            <h2 style={{ fontSize: '2rem', lineHeight: '1.2', letterSpacing: '-0.02em' }} className="text-foreground mb-8 text-center">
            ...
            <div className="relative overflow-hidden">
              ...
              <div className="flex gap-6 animate-marquee">
                {/* First set */}
                {[
                  { project: "Лендинг для стартапа", price: "180 000 ₽", time: "2 недели" },
                  { project: "Корпоративный сайт банка", price: "650 000 ₽", time: "6 недель" },
                  { project: "Интернет-магазин одежды", price: "750 000 ₽", time: "8 недель" },
                  { project: "SaaS платформа", price: "1 200 000 ₽", time: "12 недель" },
                  { project: "UI/UX для мобильного приложения", price: "220 000 ₽", time: "3 недели" },
                  { project: "Дизайн-система для корпорации", price: "480 000 ₽", time: "5 недель" },
                  { project: "AI чат-бот для e-commerce", price: "280 000 ₽", time: "4 недели" },
                  { project: "Голосовой ассистент для колл-центра", price: "520 000 ₽", time: "7 недель" },
                  { project: "CRM система для агентства", price: "890 000 ₽", time: "10 недель" },
                ].map((example, index) => (
                  <div
                    key={`first-${index}`}
                  ...
                  >
                    <div className="flex items-start justify-between mb-3">
                      <p className="text-foreground" style={{ fontSize: '1.125rem' }}>{example.project}</p>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-accent" style={{ fontSize: '1.5rem', letterSpacing: '-0.02em' }}>{example.price}</span>
                      <span className="text-muted-foreground text-sm">{example.time}</span>
                    </div>
                  </div>
                ))}
