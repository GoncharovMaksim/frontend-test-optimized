...
import { SEO, generateFAQSchema } from "../SEO";
import { STUDIO_NAME, SITE_ORIGIN } from "../../utils/constants";
import { PageHeading, PageDescription } from "../ui/Typography";
...
const faq = [
  {
    ...
    answer: "Стоимость зависит от сложности проекта. Лендинг от 100 000₽, корпоративный сайт от 300 000₽, веб-приложение от 500 000₽. Точную оценку даем после брифинга.",
  },
  {
    question: "Сколько времени займет разработка?",
    answer: "MVP лендинга — 2 недели, корпоративного сайта — 4-6 недель, сложного веб-приложения — 2-4 месяца. Работаем итерациями с промежуточными демо.",
  },
  {
    question: "Вы работаете с клиентами из других городов?",
    answer: "Да, 70% наших клиентов из регионов. Вся коммуникация онлайн через Telegram, Zoom и Notion. География не влияет на качество работы.",
  },
  {
    question: "Что нужно для старта проекта?",
    answer: "Заполните бриф на нашем сайте или напишите в Telegram. Проведем созвон, обсудим задачу, составим план и смету. После согласования — сразу приступаем к работе.",
  },
  {
    question: "Предоставляете ли техподдержку?",
    answer: "Да, первый месяц после запуска — бесплатная техподдержка. Дальше можем заключить договор на сопровождение или работать по запросу.",
  },
  {
    question: "Можно ли начать с малого бюджета?",
    answer: "Да! Можем начать с MVP, протестировать гипотезу и масштабировать проект по мере роста бизнеса. Главное — четкое понимание целей.",
  },
  {
    question: "Какие технологии вы используете?",
    answer: "React, Next.js, TypeScript для фронтенда. Node.js, Python для бэкенда. Работаем с современным стеком: Tailwind CSS, PostgreSQL, Redis, Docker.",
  },
  {
    question: "Вы работаете по договору?",
    answer: "Да, все проекты оформляем официально. Заключаем договор с ИП или ООО, работаем с НДС и без. Готовы к длительному сотрудничеству.",
  },
];
  ...
  return (
    <div className="min-h-screen bg-background pt-24">
      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-8 pb-12">
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 style={{ fontSize: '1.25rem' }} className="text-foreground mb-3">
                    {item.question}
                  </h3>
        ...
        >
          <h3 style={{ fontSize: '1.5rem' }} className="text-foreground mb-4 text-balance">
