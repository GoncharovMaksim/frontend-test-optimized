...
import { 
  Award, BookOpen, Heart, Zap, 
  Code, Palette, Server, Bot, Briefcase,
  Send, Mail, Star, TrendingUp
} from "lucide-react";
import { ImageWithFallback } from "../figma/ImageWithFallback";
import { SEO } from "../SEO";
import { STUDIO_NAME, SITE_ORIGIN, TELEGRAM_URL, CONTACT_EMAIL } from "../../utils/constants";

const culture = [
  {
    icon: Zap,
    title: "Быстрые решения",
    description: "Работаем в режиме стартапа: быстро принимаем решения и не боимся экспериментов.",
  },
  {
    icon: BookOpen,
    title: "Постоянное обучение",
    description: "Каждый месяц изучаем новые технологии и делимся знаниями внутри команды.",
  },
  {
    icon: Heart,
    title: "Забота о команде",
    description: "Гибкий график, удаленная работа, медстраховка и компенсация обучения.",
  },
  {
    icon: Award,
    title: "Качество кода",
    description: "Code review, тестирование, документация — стандарт для каждого проекта.",
  },
];
  ...
  return (
    <div className="min-h-screen bg-background pt-24">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 pb-20">
        ...
        >
          <h1 style={{ fontSize: '4rem', lineHeight: '1.1', letterSpacing: '-0.02em' }} className="text-foreground mb-6">
            Наша команда
          </h1>
          <p className="text-muted-foreground max-w-3xl mx-auto" style={{ fontSize: '1.25rem' }}>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-20">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Глубокие знания в современных технологиях и лучших практиках разработки
          </p>
        </motion.div>
          ...
          {expertise.map((expert, index) => {
            ...
            return (
              ...
              >
                ...
                <h3 style={{ fontSize: '1.25rem' }} className="text-foreground mb-2">
                  {expert.title}
                </h3>
            ...
            {culture.map((item, index) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 style={{ fontSize: '1.5rem' }} className="text-foreground mb-3">
                    {item.title}
                  </h3>
      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-8 py-20">
        ...
        >
          <h3 style={{ fontSize: '2.5rem', lineHeight: '1.2' }} className="text-foreground mb-4">
            Присоединяйтесь к команде
          </h3>
          <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
            Ищем талантливых разработчиков, дизайнеров и менеджеров для работы над интересными проектами
          </p>
