...
import {
  Globe, Palette, Bot, Workflow,
  Check, Send, Mail, Zap, Shield, Clock, Users
} from "lucide-react";
import { ImageWithFallback } from "../figma/ImageWithFallback";
import { CTASection } from "../CTASection";
import { SEO, servicesSchema } from "../SEO";
...
const serviceDetails = [
  {
    ...
    image: "https://images.unsplash.com/photo-1531498860502-7c67cf02f657?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzb2Z0d2FyZSUyMGRldmVsb3BtZW50JTIwY29kZXxlbnwxfHx8fDE3NjIxMDAzODd8MA&ixlib=rb-4.1.0&q=80&w=1080",
  },
  {
    icon: Palette,
    title: "UI/UX Дизайн",
    ...
    image: "https://images.unsplash.com/photo-1572882724878-e17d310e6a74?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxncmFwaGljJTIwZGVzaWduJTIwdG9vbHN8ZW58MXx8fHwxNzYyMTUzODMwfDA&ixlib=rb-4.1.0&q=80&w=1080",
  },
  {
    icon: Bot,
    title: "AI-агенты",
    ...
    image: "https://images.unsplash.com/photo-1531545514256-b1400bc00f31?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx0ZWFtJTIwY29sbGFib3JhdGlvbiUyMG1lZXRpbmd8ZW58MXx8fHwxNzYyMTE1MTgyfDA&ixlib=rb-4.1.0&q=80&w=1080",
  },
  {
    icon: Workflow,
    ...
    <div className="min-h-screen bg-background pt-24">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-20">
        <motion.h2
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.6 }}
          style={{ fontSize: '3rem', lineHeight: '1.2', letterSpacing: '-0.02em' }}
        ...
        <div className="space-y-12">
          {serviceDetails.map((service, index) => {
            ...
            return (
              ...
              >
                {/* Image */}
                <div className={`relative h-80 rounded-2xl overflow-hidden ${!isEven ? "lg:col-start-2" : ""}`}>
                  <ImageWithFallback
                    src={service.image}
                    alt={service.title}
                ...
                <div className={isEven ? "" : "lg:col-start-1 lg:row-start-1"}>
                  <h3 style={{ fontSize: '2rem', lineHeight: '1.2' }} className="text-foreground mb-4">
                    {service.title}
                  </h3>
      ...
      <div className="bg-secondary/20 py-20 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <motion.div
            ...
            className="text-center mb-12"
          >
            <h2 style={{ fontSize: '3rem', lineHeight: '1.2', letterSpacing: '-0.02em' }} className="text-foreground mb-4">
              Технологии
            </h2>
          ...
          <div className="relative">
            <div className="flex gap-4 animate-marquee">
              ...
              {technologies.map((tech) => (
                ...
                >
                  <div className="text-muted-foreground whitespace-nowrap">{tech.name}</div>
                  <div className="text-accent whitespace-nowrap">{tech.category}</div>
                </div>
              ))}
