...
import { STUDIO_NAME, SITE_ORIGIN, CONTACT_EMAIL, TELEGRAM_URL } from "../utils/constants";
...
export const organizationSchema = {
  ...
  "description": "Студия веб-разработки, дизайна и AI-решений. Создаем сайты, дизайн, AI-агентов и автоматизируем бизнес-процессы.",
  "address": {
    "@type": "PostalAddress",
    "addressCountry": "RU"
  },
    ...
    "itemListElement": [
      {
        ...
        "itemOffered": {
          "@type": "Service",
          "name": "Веб-разработка",
          "description": "Создание лендингов, корпоративных сайтов, интернет-магазинов и веб-приложений"
        }
      },
      {
        "@type": "Offer",
      ...
      },
      {
        ...
        "itemOffered": {
          "@type": "Service",
          "name": "AI-агенты",
          "description": "Разработка чат-ботов, голосовых ассистентов и автоматизация поддержки"
        }
      },
      {
        "@type": "Offer",
