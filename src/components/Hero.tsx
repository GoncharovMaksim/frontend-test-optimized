...
import { fadeInUp, fadeIn, hoverScale, tapScale, viewportProps } from "../utils/motionConfig";
import { PageHeading, PageDescription, GradientText } from "./ui/Typography";
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8 py-16 sm:py-24 lg:py-32 text-center">
        ...
        >
          ...
          >
            <span className="text-muted-foreground">Digital & AI Solutions</span>
          </motion.div>
          ...
          <PageDescription
            variants={fadeInUp}
          >
            Разрабатываем сайты, создаем дизайн, внедряем AI-агентов и автоматизируем
            бизнес-процессы. От идеи до полной реализации.
          </PageDescription>
        ...
        {animConfig.complexAnimations && (
          <>
            <div
              className="absolute top-1/4 left-1/4 w-64 h-64 bg-accent/10 rounded-full blur-3xl pointer-events-none animate-float-slow"
            />
            <div
              className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-purple-500/10 rounded-full blur-3xl pointer-events-none animate-float-slower"
            />
          </>
        )}
      </div>
