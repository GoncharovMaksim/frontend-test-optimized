...
export function ContactModal({ open, onOpenChange, title, description }: ContactModalProps) {
          ...
          <div className="relative min-h-[510px]">
            <AnimatePresence mode="wait">
              {isSubmitted ? (
                ...
                >
                  <div>
                    <label htmlFor="modal-name" className="block text-foreground mb-2">
                  ...
                  <div>
                    <label htmlFor="modal-email" className="block text-foreground mb-2">
                  ...
                  <div>
                    <label htmlFor="modal-telegram" className="block text-foreground mb-2">
                      Telegram или номер телефона <span className="text-accent">*</span>
                    </label>
                    <input
                      type="text"
                      id="modal-telegram"
                  ...
                  <div>
                    <label htmlFor="modal-message" className="block text-foreground mb-2">
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <div className="flex-1">
                ...
                <div className="text-muted-foreground">@{TELEGRAM_URL.replace('https://t.me/','')}</div>
              </div>
            </motion.a>
