...
import {
  Target, Lightbulb, Code, TestTube, Rocket, LineChart, CheckCircle2
} from "lucide-react";
...
export function Process() {
  return (
    <section id="process" className="relative py-24 lg:py-32 px-6 lg:px-8 overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            От первого звонка до запуска продукта — прозрачный и предсказуемый процесс
          </p>
        </motion.div>
