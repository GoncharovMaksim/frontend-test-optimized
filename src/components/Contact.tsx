    ...
    <section id="contact" className="px-6 lg:px-8 pt-0 pb-20">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <ContactDescription>
            Есть идея для сайта? Нужен AI-агент? Хотите автоматизировать процессы?
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            ...
            <FeatureDescription>Отвечаем в течение 2 часов в рабочее время</FeatureDescription>
          </FeatureCard>
          ...
          >
            ...
            <FeatureDescription>Бесплатный аудит и оценка проекта</FeatureDescription>
          </FeatureCard>
          ...
          >
            ...
            <FeatureDescription>Подстраиваемся под ваши сроки и бюджет</FeatureDescription>
          </FeatureCard>
        </div>
      </div>
