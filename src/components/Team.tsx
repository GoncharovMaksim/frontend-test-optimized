...
import { Code, Palette, Server, Bot, Briefcase } from "lucide-react";
import { JOBS_EMAIL } from "../utils/constants";
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-20">
          {stats.map((stat, index) => (
            ...
            >
              <div style={{ fontSize: '3rem', lineHeight: '1' }} className="text-accent mb-2">
                {stat.value}
              </div>
          ...
          >
            <div className="relative rounded-2xl overflow-hidden border border-border bg-secondary/30 backdrop-blur-sm h-full min-h-[500px]">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8">
                <p className="text-foreground mb-2" style={{ fontSize: '1.5rem' }}>
                  Команда из 15+ профессионалов
                </p>
                <p className="text-muted-foreground">
                  Мы объединили экспертизу в веб-разработке, дизайне, AI и автоматизации процессов
                </p>
              </div>
            </div>
